...
<head>
    ...
    <!--==================================================================== 
                        Start Custome Title Section
    =====================================================================-->
    <?php if (strpos($_SERVER['REQUEST_URI'], "yayasan-yatim-piatu-terdekat") !== false) { ?>
    <title>Yayasan Yatim Piatu Terdekat</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "yayasan-yatim-ziswaf") !== false) { ?>
    <title>Yayasan Yatim Ziswaf</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "yayasan-yatim-dhuafa") !== false) { ?>
    <title>Yayasan Yatim Dhuafa</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "rumah-yatim-dhuafa") !== false) { ?>
    <title>Rumah Yatim Dhuafa</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "donasi-yatim-piatu") !== false) { ?>
    <title>Donasi Yatim Piatu</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "dompet-dhuafa-zakat") !== false) { ?>
    <title>Dompet Dhuafa Zakat</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "wakaf-dompet-dhuafa") !== false) { ?>
    <title>Wakaf Dompet Dhuafa</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "donasi-dompet-dhuafa") !== false) { ?>
    <title>Donasi Dompet Dhuafa</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "yayasan-dompet-dhuafa") !== false) { ?>
    <title>Yayasan Dompet Dhuafa</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "sedekah-yatim-piatu") !== false) { ?>
    <title>Sedekah Yatim Piatu</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "yayasan-yatim-piatu") !== false) { ?>
    <title>Yayasan Yatim Piatu</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "rumah-yatim-piatu") !== false) { ?>
    <title>Rumah Yatim Piatu</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "badan-wakaf-alquran") !== false) { ?>
    <title>Badan Wakaf AlQuran</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "yayasan-dompet-yatim-indonesia") !== false) { ?>
    <title>Yayasan Dompet Yatim Indonesia</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "panti-asuhan-terdekat") !== false) { ?>
    <title>Panti Asuhan Terdekat</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "pondok-yatim-dan-dhuafa") !== false) { ?>
    <title>Pondok Yatim dan Dhuafa</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "program-wakaf-alquran") !== false) { ?>
    <title>Program Wakaf AlQuran</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "sedekah-online-terpercaya") !== false) { ?>
    <title>Sedekah Online Terpercaya</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "panti-asuhan-samarinda") !== false) { ?>
    <title>Panti Asuhan Samarinda</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "yayasan-panti-asuhan") !== false) { ?>
    <title>Yayasan Panti Asuhan</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "yayasan-panti-asuhan-terdekat") !== false) { ?>
    <title>Yayasan Panti Asuhan Terdekat</title>
    <?php } elseif (strpos($_SERVER['REQUEST_URI'], "panti-asuhan-pontianak") !== false) { ?>
    <title>Panti Asuhan Pontianak</title>
    <?php } ?>
    <!--==================================================================== 
                        End Custome Title Section
    =====================================================================-->
    ...
    <meta name="title" content="Yayasan Generasi Yatim Tahfidz">
    <meta name="description"
        content="Generasi yatim tahfidz merupakan yayasan yatim piatu atau lembaga sosial yang bersifat non-profit dan berfokus mencetak generasi tahfidz Al-Qur’an">
    <meta name="keywords"
    ...
    <meta property="og:title" content="Yayasan Generasi Yatim Tahfidz">
    ...
    <meta property="twitter:title" content="Yayasan Generasi Yatim Tahfidz">
...
<body>
    ...
    =====================================================================-->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M4CG48L" height="0" width="0"
        ...
        <section class="hero-section overlay">
            <div class="container">
                <div class="hero-inner">
                    ...
                    <a href="assets/profile-ygyt.pdf" target="_blank" class="theme-btn wow fadeInUp"
                        data-wow-duration="1s" data-wow-delay="1s">Tentang YGYT<i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
        </section>
        <!--==================================================================== 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item wow fadeInUp" data-wow-duration="2s">
                            ...
                            <div class="service-content">
                                ...
                                <h4><a
                                        href="{{ route('detail_donasi', $program->id) }}">{{ $program->nama_program }}</a>
                                </h4>
