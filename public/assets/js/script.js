  ...
  $(document).ready(function () {
    ...
    if ($(".main-header .main-menu").length) {
      $(".main-header .main-menu .navbar-toggle").click(function () {
        ...
        let toogle = document.querySelector(".navbar-collapse ");
        if (toogle.classList.contains("show")) {
          console.log(toogle);
          donate.classList.remove("see");
        } else {
          donate.classList.add("see");
        }
      });
    }
      ...
      reviewContainer.addEventListener("click", (e) => {
        ...
        if ("A" == reviewBtn.nodeName) {
          ...
          let itemList = document.querySelectorAll(
            ".testimony-content .review-single"
          );
          let currentReview = document.querySelector(".review-single.active");
          let currentBtn = document.querySelector(
            ".review-buttons .review-btn.active"
          );
          let currentBtnBox = document.querySelector(
            ".review-buttons .active-btn"
          );
    ...
    if ($(".partner-wrap").length) {
      $(".partner-wrap").slick({
        ...
        arrows: true,
        prevArrow:
          '<button class="partner-prev"><i class="fas fa-angle-double-left"></i></button>',
        nextArrow:
          '<button class="partner-next"><i class="fas fa-angle-double-right"></i></button>',
        pauseOnHover: false,
        autoplaySpeed: 2000,
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    if ($(".case-wrap").length) {
      $(".case-wrap").slick({
        ...
        arrows: true,
        prevArrow:
          '<button class="case-prev"><i class="fas fa-angle-double-left"></i></button>',
        nextArrow:
          '<button class="case-next"><i class="fas fa-angle-double-right"></i></button>',
        pauseOnHover: false,
        autoplaySpeed: 2000,
        slidesToShow: 3,
        slidesToScroll: 1,
    ...
    if ($("#map").length !== 0) {
      var map = L.map("map", {
        center: [-3.4438147, 114.8640424],
        zoom: 10,
        zoomControl: false,
        scrollWheelZoom: true,
      });
      L.tileLayer("https://tile.osm.ch/switzerland/{z}/{x}/{y}.png", {}).addTo(
        map
      );
    }
  });
